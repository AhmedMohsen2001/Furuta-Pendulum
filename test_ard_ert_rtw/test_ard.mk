###########################################################################
## Makefile generated for Simulink model 'test_ard'. 
## 
## Makefile     : test_ard.mk
## Generated on : Tue Dec 19 10:57:08 2023
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test_ard.elf
...
PRODUCT_NAME              = test_ard
MAKEFILE                  = test_ard.mk
MATLAB_ROOT               = D:/College/Matlab
MATLAB_BIN                = D:/College/Matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/DeviceDrivers/SYS
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/AHMED MOHSEN/DOCUME~1/MATLAB/R2020a/ArduinoStaticLibrary/ArduinoMega2560/FasterRuns
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test_ard.elf
...
DEFINES_ = -DMODEL=test_ard -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=5 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=62411 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=test_ard -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o test_ard.o test_ard_data.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/test_ard_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/test_ard_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/test_ard_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/test_ard_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_ard.o : $(START_DIR)/test_ard_ert_rtw/test_ard.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_ard_data.o : $(START_DIR)/test_ard_ert_rtw/test_ard_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
